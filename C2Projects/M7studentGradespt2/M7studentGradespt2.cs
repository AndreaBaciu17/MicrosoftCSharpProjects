...
foreach (string name in studentNames)
{
    ...
    */
    ...
    /*calculate the extra credit points earned as follows: divide 10% of the 
    extra credit score sum by the number of exams.*/
    //currentStudentExtraCredit HERE
